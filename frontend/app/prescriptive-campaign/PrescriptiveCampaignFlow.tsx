...
export default function PrescriptiveCampaignFlow({ initialZip }: Props) {
  ...
  const currentPlatform = activePlatform
    ? platforms.find(p => p.id === activePlatform) || null
    : null;
            ...
            <div className="border-b border-gray-200 px-8">
              <div className="flex gap-8">
                <button
                  ...
                  className={`py-4 text-sm font-medium transition-colors relative ${activeTab === 'campaign' ? 'text-gray-900' : 'text-gray-500'}`}
                >
                  Campaign
                  {activeTab === 'campaign' && (
                ...
                <button
                  ...
                  className={`py-4 text-sm font-medium transition-colors relative ${activeTab === 'creative' ? 'text-gray-900' : 'text-gray-500'}`}
                >
                  Creative
                  {activeTab === 'creative' && (
                    <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-600 to-blue-600" />
